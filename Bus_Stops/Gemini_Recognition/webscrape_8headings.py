...
os.makedirs("images_metadata_8headings", exist_ok=True)
...
def fetch_stop_images(target_stop_code):
    """
    Fetches an 8-image 360-degree panorama for a specific bus stop code.
    """
    ...
    # 8 headings, every 45 degrees, giving a complete 360-degree sweep.
    # "front" points toward the bus stop. The rest rotate around the panorama.
    sweep_offsets = {
        "front": 0,
        "front_right": 45,
        "right": 90,
